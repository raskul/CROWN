    ...
    prevBlocks(0)
{
    ...
    setWindowTitle(tr("Crown") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Crown"), this);
    aboutAction->setStatusTip(tr("Show information about Crown"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Crown client"));
...
{
    QString strTitle = tr("Crown"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Crown address or malformed URI parameters."),
